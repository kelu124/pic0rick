...
There are no step-by-step assembly instructions for the three-board stack (main + pulser + HV). The `docs/images/` folder has photos but no reference designator callouts. Is a build guide planned?
