...
```text
board=pic0rick package=RP2350A firmware=1.6 dsp_backend=f32-rfft-hilbert samples=4096 sample_rate=60000000 pulser=disarmed
```
...
that the board reports firmware `1.6`; an older UF2 is rejected.
